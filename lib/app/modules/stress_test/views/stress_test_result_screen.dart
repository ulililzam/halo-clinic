...
import 'package:halo_clinic/app/common/widgets/custom_app_bar.dart';
...
class StressTestResultScreen extends StatelessWidget {
  const StressTestResultScreen({super.key});
                        ...
                        children: [
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      gradient: const LinearGradient(
                                        colors: [
                                          ...
                                          Color(0xFFFF9966), // Berat
                                          Color(0xFFFF6B6B), // Sangat Berat
                                        ],
                          ...
                          SizedBox(
                            ...
                            child: OutlinedButton(
                              onPressed: () async {
                                final success = await WhatsAppLauncher.launchStressTestResult(
  ...
  double _calculatePosition(BuildContext context, int score) {
    ...
    // Score range is 0-40 (10 questions * 4 max score)
    final percentage = (score / 40).clamp(0.0, 1.0);
